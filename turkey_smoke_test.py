...
class Turkey_smoke_test(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # cls.driver = webdriver.Chrome()
        # cls.driver.get("https://www.nestle-cereals.com/tr/tr/")
    ...
    def test_06_write_us_text(self):
        ...
        text = Selectors.text_to_assert['turk_write_text']
    ...
    def test_07_faq(self):
        ...
        text = Selectors.text_to_assert['turk_faq_text']
        CommonMethods.test_click_javascript(self,locator)
    ...
    def test_08_in_person(self):
        ...
        locator2 = Selectors.selectors['footer_active_talk_section']
        text = Selectors.text_to_assert['turk_in_person_text']
        CommonMethods.test_click_javascript(self, locator)
        CommonMethods.test_assert_text(self, text, locator2)
