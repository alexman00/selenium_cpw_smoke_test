...
class Portugal_smoke_test(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # cls.driver = webdriver.Chrome()
        # cls.driver.get("https://www.nestle-cereals.com/pt/pt")
    ...
    def test_01_click_cookie_popup(self):
        locator = Selectors.selectors["portugal_close_popup"]
    ...
    def test_06_write_us_text(self):
        ...
        text = Selectors.text_to_assert['portugal_write_text']
    ...
    def test_07_faq(self):
        ...
        text = Selectors.text_to_assert['portugal_faq_text']
        CommonMethods.test_click_javascript(self,locator)
    ...
    def test_08_in_person(self):
        ...
        locator2 = Selectors.selectors['footer_active_talk_section']
        text = Selectors.text_to_assert['portugal_in_person_text']
        CommonMethods.test_click_javascript(self, locator)
        CommonMethods.test_assert_text(self, text, locator2)
